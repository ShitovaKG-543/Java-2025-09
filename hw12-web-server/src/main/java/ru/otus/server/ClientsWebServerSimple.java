...
public class ClientsWebServerSimple implements ClientsWebServer {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(
                new ServletHolder(new ClientsListServlet(templateProcessor, dbServiceClient)), "/clients");
        servletContextHandler.addServlet(new ServletHolder(new CreateClientServlet(templateProcessor)), "/clients/new");
        servletContextHandler.addServlet(
                new ServletHolder(new ClientsApiServlet(dbServiceClient, gson, clientMapper)), "/api/clients/*");
        return servletContextHandler;
    }
}
